...
<!-- List the checks, tests, or manual verification you performed. -->

## Security and privacy checklist

- [ ] I reviewed the complete diff and did not include credentials, tokens, private keys, cookies, or secret values.
- [ ] I did not include personal memory, transcripts, sessions, runtime databases, snapshots, backups, or private project/client context.
...
<!-- Note any intentional exception, scanner suppression, or follow-up work. Write "None" when not applicable. -->
